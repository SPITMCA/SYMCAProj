...
emotion_classifier = load_model("model_weight.hdf5", compile=False)
...
while (True):
    ...
    for detection in detections:
        ...
        cv2.putText(frame, "stress level:{}".format(str(int(stress_value * 100))), (20, 40), cv2.FONT_HERSHEY_SIMPLEX,
                    0.5, (0, 255, 0), 2)
