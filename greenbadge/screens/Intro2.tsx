  ...
  return (
    <View style={styles.frame}>
      ...
      <Text style={styles.subtitle}>
        ...
        by your actions. It includes direct emissions from activities like
        driving a car, and indirect emissions from the products you buy and the
        food you eat
      </Text>
      <View style={styles.carbonFootprintInfo}>
        <Text style={styles.infoTitle}>
          Why keep track your Carbon Footprint?
        </Text>
        {[
