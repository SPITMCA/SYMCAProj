    ...
    <main class="hospital-main hospital-main-main layout">
      ...
      <section class="hospital-main-section1__section1 layout">
        <div class="hospital-main-section1__flex layout">
          ...
          <div class="hospital-main-section1__flex2 layout">
            <div class="hospital-main-section1__flex2-item">
              <div class="hospital-main-section1__flex3 layout">
                <h1 class="hospital-main-section1__hero-title layout">
                  Improving the lives of our patients and thier families
                </h1>
                <h4 class="hospital-main-section1__highlights layout">Take care of your family health</h4>
                <div class="hospital-main-section1__block1 layout">
                  <a href="/claim_form"><h4 class="hospital-main-section1__highlights1 layout">Claims</h4></a>
                </div>
                <div class="hospital-main-section1__block1 layout" id="v_report">
                <a href="{{route('report1', ['year' => 2022 ,'dis_type'=>'Cardiac'])}}"><h4 class="hospital-main-section1__highlights1 layout">Reports</h4></a>
                </div>
              </div>
            </div>
