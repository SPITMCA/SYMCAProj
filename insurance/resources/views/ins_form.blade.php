...
#cover-spin::after {
  ...
  <body style="display: flex; flex-direction: column">
      ...
      <div class="signup-flex layout">
        ...
        <div class="signup-flex2 layout">
          <div class="signup-flex2-item">
            ...
            >
              <div class="signup-txt4-box layout">
                <pre class="signup-txt4">Credentials </pre>
              </div>
          ...
          <!-- <div class="signup-flex3-item">
            <div
              style="--src:url(../images/signup/covid.jpg)"
          ...
          <img src="../images/signup/ins_form.jpg" id="ins_form_img"
              data-aos="fade-right"
              data-aos-delay="1000"
    ...
    <input type="checkbox" class="form-check-input" id="bnf" name="bnf" onchange="bnfch(this)">
    <label class="form-check-label">Iam not the beneficiary</label>
  </div>
    <form action="/doc_check" method="post"  id="u_dform"  enctype="multipart/form-data" onsubmit="doc_check_aj(event,'u_dform')">
      @csrf

  <input type="hidden"  class="form-control" id="u_dform_id0" name="u_dform_id" value="u_dform">
  <input type="hidden"  class="form-control" id="doc_main_uname" name="doc_main_uname" value="{{$doc_main_uname}}">
  <input type="hidden"  class="form-control" id="ins_uage" name="ins_uage" value="{{$docmain_age}}">
  <input type="hidden"  class="form-control" id="cvr_id" name="cvr_id" value="{{$cvr_id}}">
  <input type="hidden"  class="form-control" id="cust_iid" name="cust_iid" value="{{$cust_iid}}">
  <input type="hidden"  class="form-control" id="as_u" name="as_u" value="as">
  <input type="hidden"  class="form-control" id="benif_id" name="benif" value="yes">
  
  <div class="form-group">
    <label>Enter Aadhar number</label>
    <input type="number"  class="form-control" id="ins_uano" name="ins_uano" onblur="advalid(this)">
  </div>

   <div class="form-group">
    <label >Your Aadhar Card</label>
    <input type="file"  class="form-control" id="ins_ufile" name="ins_ufile" onblur="adfile_val(this)">
  </div>
  
  <input type="hidden"  class="form-control" id="doc_ver0" name="doc_verified" value="doc_ver0">

  <input type="submit" id="u_ver" name="u_ver" class="btn btn-warning" value="Verify data">

  <input type="hidden"  class="form-control" id="clr_form_id0" name="clr_form_id" value="clr_form">  
<br>
  ...
  <div class="form-group">
    <label>Enter n.o of  members</label>
    <input type="number" onblur="mem_form(this,'{{$cvr_id}}','{{$cust_iid}}')" class="form-control" id="ins_nom">
  </div>

  
  
  <div id="mem_form_res"></div>
  <button type="button" id="clr_form" name="clr_form" class="btn btn-danger" disabled="true" onclick="clear_form('{{$cvr_id}}','{{$cust_iid}}')" >Delete data</button>
  
  
  <input type="hidden"   id="cvr_price_id" value="{{$cvr_price}}">
    <label id="cvr_price"><i>Cover Price: </i><b><span>&#8377;</span> {{$cvr_price}}</b></label>

    <label id="bill_amt"><i>Your Bill: </i><b><span>&#8377;</span> {{$cvr_price}}</b></label>
    <div id="bill_amount"></div>

    <form action="/pay_data" method="POST" >
      @csrf
  <input type="hidden"   id="cvr_price_upd" name="cvr_price_upd" value="{{$cvr_price}}">
  <input type="hidden"   id="pay_custid" name="pay_custid" value="{{$cust_iid}}">
  <input type="hidden"   id="pay_cvid" name="pay_cvid" value="{{$cvr_id}}">

  <button type="submit"  id="sub" class="btn btn-primary" >Pay</button>
</form>
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"
    ...
    <script src='https://unpkg.com/tesseract.js@v2.1.0/dist/tesseract.min.js'></script>
        ...
        <script type="text/javascript" src="js/ins_form.js"></script>
