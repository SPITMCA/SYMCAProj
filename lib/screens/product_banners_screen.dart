...
import 'package:shukran_vendor/widgets/product_banner_card.dart';

class ProductBannerScreen extends StatefulWidget {
  static const String id = 'product_banner_screen';

  @override
  _ProductBannerScreenState createState() => _ProductBannerScreenState();
}

class _ProductBannerScreenState extends State<ProductBannerScreen> {
  bool _visible = false;
  File _image;
                                ...
                                child: FlatButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    uploadBannerImage(
                                        ...
                                        .then((url) {
                                      if (url != null) {
                                        _services.saveProductBanner(url);
                                        setState(() {
  ...
  Future<String> uploadBannerImage(filePath, shopName) async {
    ...
    try {
      await _storage.ref('productBanner/$shopName/$timeStamp').putFile(file);
    } on FirebaseException catch (e) {
      // e.g, e.code == 'canceled'
      print(e.code);
    }
    String downloadURL = await _storage
        .ref('productBanner/$shopName/$timeStamp')
        .getDownloadURL();
    return downloadURL;
  }
}
